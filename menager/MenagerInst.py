...
class MenagerInst:
    ...
    def list(self):
        if self.sessionCheck():
            ...
            return dict(current="Laboratory manger", response=OSTools.OSTools.prepareJSON(self.osKSInst.list()))
        else:
    ...
    def create(self):
        try:
            ...
            return dict(current="Image manager", stats="OK", data=OSTools.OSTools.prepareJSON(image)[0])
