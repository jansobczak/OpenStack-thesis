...
curl -s -L -X DELETE --cookie cookies  http://localhost:8080/group/name/moderators/name/test_user | python -m json.tool
curl -s -L -X GET --cookie cookies  http://localhost:8080/group/name/moderators/name/test_user | python -m json.tool

curl -s -L -X DELETE --cookie cookies  http://localhost:8080/group/name/moderators/id/51d8136ebdfd45489b14039543cb76e6 | python -m json.tool
